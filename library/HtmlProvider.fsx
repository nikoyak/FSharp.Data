...
val stats : (string * decimal) [] =
  [|("4.2", 99687M); ("4.1", 82193M); ("4.0", 45154M); ("3.3", 727622M);
    ("3.2", 18314M); ("3.1", 197147M); ("3.0", 375882M); ("2.4", 412113M);
    ("2.3", 484798M); ("2.2", 286085M); ("2.1", 28616M); ("2.0", 86644M);
    ("1.1", 77407M); ("1.0", 25663M)|]*)
(**
